...
/// Welcome prestataire — format Figma (hero image + bénéfices + checklist).
class ServiceProviderWelcomeScreenM extends StatelessWidget {
  ...
  static const _heroAsset = 'assets/welcome/metier.png';
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          'Créez votre profil prestataire et permettez aux clients de découvrir vos services près de chez eux.',
                        ...
                        _BenefitRow(
                          ...
                          description:
                              'Votre profil peut être découvert par des personnes recherchant vos services dans votre zone.',
                        ),
                        ...
                        _BenefitRow(
                          ...
                          description:
                              'Ajoutez vos métiers, vos tarifs, votre expérience et vos réalisations.',
                        ),
                        const SizedBox(height: 18),
                        _BenefitRow(
                          icon: Icons.chat_bubble_outline_rounded,
                          title: 'Gérez vos demandes depuis l’application',
                          description:
                              'Une fois votre profil activé, retrouvez vos demandes, échanges et missions dans votre espace prestataire.',
                        ),
                        const SizedBox(height: 28),
                        Text(
                        ...
                        const _PrepItem(label: 'Votre métier et vos spécialités'),
                        const _PrepItem(label: 'Votre zone d’intervention'),
                        const _PrepItem(label: 'Une photo de profil'),
                        const _PrepItem(
                            label: 'Vos informations professionnelles'),
                        const _PrepItem(
                          label:
                              'Les documents demandés pour la vérification, si nécessaire',
                          isLast: true,
                        ),
          ...
          ClipPath(
            ...
            child: Stack(
              ...
              children: [
                ...
                // Légère teinte pour lisibilité logo / close
                DecoratedBox(
                  decoration: BoxDecoration(
...
/// Vague concave en bas du hero (format Figma).
